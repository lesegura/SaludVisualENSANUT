...
plot <- tab_est_coefs |>
  ...
  ggthemes::scale_color_tableau(palette = "Color Blind") +  # Apply color-blind palette
  labs(y = "",
       title = "") 

### FOrmatting for submission to Lancet Regional Health Americas
...
### Remove captions and title for submission to Social Science & Medicine
ggsave(here("results/", "Mohamed_figure_1_ssm.pdf"), plot = plot,
       width = 12, height = 7, device = cairo_pdf, units = "in", dpi = 1800, bg = "transparent")

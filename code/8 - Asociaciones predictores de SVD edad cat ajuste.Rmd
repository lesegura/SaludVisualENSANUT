...
# ggsave(here("results/", "forestplot_age_cat_adj.jpeg"), width = 12, height = 8, units = "in", dpi = 1800)
...
# ggsave(here("results/", "forestplot2_age_cat_adj.pdf"), width = 12, height = 6, device = "pdf", units = "in", dpi = 1800)
# ggsave(here("results/", "forestplot2_age_cat_adj.jpeg"), width = 12, height = 8, units = "in", dpi = 1800)

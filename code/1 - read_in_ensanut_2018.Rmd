...
grep("p11_8", names(adultos), value = T)
...
design.ensanut |>
  mutate(dv = ifelse(p14_3 %in% c(1, 2), 0, 1)) |>
  filter(p11_1 == 1) |>
  group_by(dv, p11_8) |>
...
design.ensanut |>
  mutate(p3_7_8 = ifelse(p3_7_8 == 2, 0, 
                         ifelse(p3_7_8 == 9, NA, p3_7_8)), 
         p3_6_r = case_when(p3_6 %in% c("01", "02") ~ "IMSS", 
                          p3_6 %in% c("03", "04", "11") ~ "SS", 
                          p3_6 %in% c("05") ~ "DIF y CR", 
                          p3_6 %in% c("06", "07") ~ "ISSSTE", 
                          p3_6 == "08" ~ "Marina, Defensa, PEMEX", 
                          p3_6 == "09" ~ "Privado", 
                          p3_6 == "10" ~ "Hospital Civil", 
                          p3_6 == "12" ~ "Consultorios de Farmacias", 
                          p3_6 %in% c("13", "14") ~ "Otras")) |>
  group_by(p3_6_r) |>
  summarise(n = n(), 
            prop = survey_mean(p3_7_8, na.rm = T)) |>
...
- p13_11, p13_14, p13_15. Primera para si/no,ultimas para binge
...
```{r}
ensanut18_all_small <- ensanut18_all |>
  rename(sexo = sexo.x, 
         edad = edad.x, 
         region = region.x,
         estrato = estrato.x, 
         ...
         upm_dis = upm_dis.x, 
         dominio = dominio.x) |>
  select(upm:numren, edad:f_20mas, l_indigena, p2_1_1:p2_1_7, dv_bin, p14_1, p14_3, p3_21, p3_23, p3_26_1, p3_26_2, nivel, p7_2_1, p7_2_2, p7_2_3, p5_1_01:p5_1_19, p3_9_01:p3_9_99, p3_1, p4_1)

save(ensanut18_all_small, file = here("data/", "ensanut18_all_small.RData"))

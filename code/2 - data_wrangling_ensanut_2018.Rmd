...
ensanut18_4analysis <- ensanut18_all |>
  ...
  mutate(ses = factor(case_when(estrato == 1 ~ 4, 
         ...
         accidente_lim = factor(case_when(accidente == "No" & is.na(dis_accidente) ~ 1, 
                                   accidente == "Yes" & dis_accidente == "Ninguno" ~ 2, 
                                   accidente == "Yes" & dis_accidente == "Limitación motora" ~ 3, 
                                   accidente == "Yes" & dis_accidente == "Limitación para hablar u oír" ~ 4, 
                                   accidente == "Yes" & dis_accidente == "Dificultad para ver o ceguera" ~ 5,
                                   accidente == "Yes" & dis_accidente == "Otra limitación física o mental" ~ 6), 
                                labels = c("No accident", "No disability due to accident", "Functional disability", 

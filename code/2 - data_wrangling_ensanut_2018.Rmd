...
ensanut18_4analysis <- ensanut18_all |>
  ...
  mutate(ses = factor(case_when(estrato == 1 ~ 4, 
         ...
         smk_cat = factor(case_when(smk_curr == "No" & smk_former == "No" ~ 0, 
                             smk_curr == "No" & smk_former == "Yes" ~ 1, 
                             smk_curr == "Yes" ~ 2), labels = c("Never", "Former", "Current")), 
         ...
         heavy_drnk = case_when(p13_14 > 88 ~ NA,
                                ...
                                p13_14 < 5 ~ 0, 
                                p13_14 == 98 ~ 2), 
         alcohol = factor(ifelse(p13_11 == 2, 0, 
                          ifelse(p13_11 == 3, 2, p13_11)), labels = c("No", "Yes", "Never")), 
         alcohol_cat = factor(case_when(alcohol == "Never" ~ 0, 
                                 alcohol == "No" ~ 1, 
                                 alcohol == "Yes" & binge_drnk == 0 & heavy_drnk == 0 ~ 2,
                                 alcohol == "Yes" & is.na(binge_drnk) | is.na(heavy_drnk) ~ 2,
                                 alcohol == "Yes" & binge_drnk == 1 ~ 3), labels = c("Never", "Former", "Current, no binge", "Binge")),
...
ensanut18_4analysis <- ensanut18_4analysis |>
  select(upm:ent, est_dis:f_20mas, age_cat, sexo, urbanicity, education, ses, insurance, l_indigena, work_pwk, work_type, diabetes, 
         ...
         cesd, obesidad, cardio_dis, kidney_dis, dyslipidemia, smk_cat, alcohol_cat)

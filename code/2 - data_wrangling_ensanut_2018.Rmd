...
ensanut18_4analysis <- ensanut18_all |>
  ...
  mutate(ses = factor(case_when(estrato == 1 ~ 4, 
         ...
         work_pwk = factor(ifelse(trabajo == 2, 0, trabajo), labels = c("No", "Yes")), 
         ...
         dis_accidente = factor(case_when(disc_visual_accdnt == 7 ~ 0, 
                                ...
                                labels = c("Ninguno", "Limitación motora", "Limitación para hablar u oír", 
                                           "Dificultad para ver o ceguera", "Otra limitación física o mental"))) 
...
ensanut18_4analysis <- ensanut18_4analysis |>
  select(upm:ent, est_dis:f_20mas, age_cat, sexo, urbanicity, education, ses, insurance, l_indigena, work_pwk, work_type, diabetes, 
         ...
         cesd, obesidad, cardio_dis, kidney_dis, dyslipidemia, smk_cat, alcohol, binge_drnk, accidente, dis_accidente)

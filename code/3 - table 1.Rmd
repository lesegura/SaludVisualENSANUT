...
nombres_var <- names(ensanut18_4analysis)[-c(1:5, 7:11, 28:30)]

### Ccreamos una función para calcular las n y prevalencias de las diferentes covariables.
fun_desc <- function(x) {
...
table_1 |>
  ...
  mutate(var = recode(var, age = "Age", 
                      ...
                      work_type = "Job type", 
                      diabetes = "Diabetes", 
                      diab_check = "Where was diabetes checked", 
                      diab_rev = "Diabetes visual check referred", 
